...
def citacoes():
    mensagem = "O computador não tem noção do tempo; tudo o que ele sabe é quando."
"A programação é uma tarefa como qualquer outra: se você quer fazê-la bem, precisa primeiro aprender como fazê-la bem."
"Se depurá-lo é a atividade de remover erros, então programar deve ser a atividade de colocá-los."
